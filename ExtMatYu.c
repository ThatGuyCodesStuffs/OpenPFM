/** External material model to linearly hardening plastic solid with Mises Yielding **/
...
EXPORT int eval(double e[6],         // Input: Green-Lagrange strain tensor components in Voigt order (xx,yy,zz,yz,zx,xy)
  ...
  double sigTrialEff,sigYs,Fn;   // Effective trial stress, current yield stress, trial
  double dep,epEff;              // Plastic strain increment and effective plastic strain
